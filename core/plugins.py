    ...
    def stop(self):
        ...
        for module in self.enabled:
            try:
                ...
                log.exception(
                    "go fuck yourself Unable to stop auxiliary module: %s",
...
class RunProcessing(object):
    ...
    def run(self):
        ...
        # Return the fat dict.
        # log.warning(results["target"]["file"]["md5"])
        # log.warning(results["network"])
        return results
...
class RunSignatures(object):
    ...
    def __init__(self, results):
        ...
        # log.warning("------------")
        # log.warning(self.results)
        # log.warning("------------")

        # csv_file = "/home/cuckoo/.cuckoo/ioc_file/ioc_ip.csv"
